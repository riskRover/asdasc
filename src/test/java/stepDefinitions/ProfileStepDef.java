...
public class ProfileStepDef {
    ...
    public void i_click_on_select_deslect_a(String string, String string2) throws InterruptedException {
        ...
        // System.out.println("Is Chennai already selected? " + isSelected);
        if (isSelected) {
            pp.removeLocation();
            // System.out.print("Removed Chennai to location preference");
        } else {
            pp.addLocation();
            // System.out.print("Added Chennai to location preference");
        }
        // System.out.println("Executed method: " + (isSelected ? "removeLocation()" : "addLocation()"));
    ...
    public void resume_should_br_uploaded_successfully() {
        ...
        assertTrue(name.contains("resume.pdf"));
